...
INPUT_CSV = os.path.join("output_acoustic_residualised", "acoustic_residualized.csv")

OUTPUT_CSV = os.path.join(SCRIPT_DIR, "acoustic_residualized_filtered.csv")
...
ALLOWED_SUBJECTS = [
    ...
    "Lang-LBD_pilot_P10", "Lang-LBD_pilot_P14", "Lang-LBD_pilot_P15",
    "Lang-LBD_pilot_P5", "Lang-LBD_pilot_P7",
