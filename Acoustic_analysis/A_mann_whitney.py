# MANN-WHITNEY U test + boxploty (akustika)
...
CLUSTER_FILE = os.path.join(SCRIPT_DIR, "output_clustering_acoustic", "mci_lb_shluky.csv")
COMPOSITE_FILE = os.path.join(SCRIPT_DIR, "output_domain_scores_acoustic", "composite_domain_scores.csv")

OUTPUT_DIR = os.path.join(SCRIPT_DIR, "output_mann_whitney_acoustic")
